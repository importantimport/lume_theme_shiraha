import type { StrictPresetOptions } from 'https://deno.land/x/fff@v1.2.1/src/utils/presets/strict.ts'
import { Field } from 'https://cdn.jsdelivr.net/gh/lumeland/cms@v0.3.7/types.ts'
