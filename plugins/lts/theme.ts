...
export default (userOptions?: Partial<Options>) => (site: Lume.Site) => {
  ...
  const applyDefaultTheme = (page: Page<Data>) => {
    ...
    const themeColorLight = page.document!.createElement('meta')
    ...
    const themeColorDark = page.document!.createElement('meta')
